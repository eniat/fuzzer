...
class UtilService(Protocol):
    ...
    def sort_wordlist(self, name_or_path: Any) -> Path: ...
...
class Crawler(Protocol):
    """
        Port for the Crawlers
    """
    name: str

    def run(self, start_url: str, ctx: Optional[Any] = None, **kwargs: Any) -> tuple[list[dict], list[dict]]: ...

class CrawService(Protocol):
    """
        Factory for the Crawlers
    """
    def create(self, kind: str, **kwargs: Any) -> Crawler: ...
