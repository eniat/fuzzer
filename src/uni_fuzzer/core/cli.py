...
def buildParser():
    ...
    parser.add_argument("-O", "--output-to-json", action="store_true", help="Save output to a json file")
    ...
    parser.add_argument("-ll", "--log-level", default="INFO", choices=["DEBUG", "INFO", "WARNING","ERROR"], help="Logging level")
