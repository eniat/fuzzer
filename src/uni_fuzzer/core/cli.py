...
def buildParser():
    ...
    parser.add_argument("--pwordlist", type=str, help="Wordlist for path traversal and parameter fuzzing")
    parser.add_argument("--xwordlist", type=str, help="Wordlist for XSS fuzzing")
    parser.add_argument("--swordlist", type=str, help="Wordlist for SQLi fuzzing")
